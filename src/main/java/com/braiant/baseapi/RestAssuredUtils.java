...
public class RestAssuredUtils {
    ...
    public static ResponseOptions<Response> postWithBodyParameter(String key, String value, Map<String, ?> body){
        request.pathParam(key,value);
        request.body(body);
        return request.post(ServiceFactory.getEndPoint());
    }

    public static ResponseOptions<Response> postWithBodyParameters(Map<String,?> pathParameters, Map<String, ?> body){
    ...
    public static ResponseOptions<Response> getEndPoint(Map<String, ?> body) {
        request.body(body);
        return request.put(ServiceFactory.getEndPoint());
    }
