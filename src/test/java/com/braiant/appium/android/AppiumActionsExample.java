package com.braiant.appium.android;
...
public class AppiumActionsExample extends AndroidBaseTest {
    ...
    void miscellaneous() throws InterruptedException {
        ...
        driver.findElement(AppiumBy.id("android:id/edit")).sendKeys("Braiant Cuevas");
        driver.findElements(AppiumBy.className("android.widget.Button")).get(1).click();
        driver.pressKey(new KeyEvent(AndroidKey.DEL));//Remueve la "K" que se agrega al final del paso previo
